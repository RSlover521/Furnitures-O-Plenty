...
public class ModCreativeTabs {
	...
	public static final FopDeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS = 
			FopDeferredRegister.create(Registries.CREATIVE_MODE_TAB, FurnituresOPlentyCommon.MODID);

	public static final RegistrySupplier<CreativeModeTab> FURNITURE_COMPAT_TAB = CREATIVE_MODE_TABS.register("furnituresoplenty",
            () -> CreativeModeTab.builder(CreativeModeTab.Row.TOP, 0)
                    .title(Component.translatable("itemGroup." + FurnituresOPlentyCommon.MODID))
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        if(Platform.isModLoaded("backpacked") && ModItems.FIR_BACKPACK_SHELF != null) {
