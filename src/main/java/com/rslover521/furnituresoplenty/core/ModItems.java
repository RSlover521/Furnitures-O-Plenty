...
public class ModItems {
    ...
    public static RegistryObject<Item> FIR_BACKPACK_SHELF;
    public static RegistryObject<Item> PINE_BACKPACK_SHELF;
    public static RegistryObject<Item> MAPLE_BACKPACK_SHELF;
    public static RegistryObject<Item> REDWOOD_BACKPACK_SHELF;
    public static RegistryObject<Item> MAHOGANY_BACKPACK_SHELF;
    public static RegistryObject<Item> JACARANDA_BACKPACK_SHELF;
    public static RegistryObject<Item> PALM_BACKPACK_SHELF;
    public static RegistryObject<Item> WILLOW_BACKPACK_SHELF;
    public static RegistryObject<Item> DEAD_BACKPACK_SHELF;
    public static RegistryObject<Item> MAGIC_BACKPACK_SHELF;
    public static RegistryObject<Item> UMBRAN_BACKPACK_SHELF;
    public static RegistryObject<Item> HELLBARK_BACKPACK_SHELF;
    public static RegistryObject<Item> EMPYREAL_BACKPACK_SHELF;
